...
<div id="header">
    <div class="head_inner">
        <h1><a title="Application Platform 배포파이프라인" href="javascript:void(0);" onclick="procMovePage('/');">
            <img alt="Application Platform 배포파이프라인" src="<c:url value='/resources/images/logo.png'/>" style="width: 42px; height: 42px;"><span>배포파이프라인</span></a></h1>
        <ul class="RP_title">
