package delivery.pipeline.ui.common;

import delivery.pipeline.ui.serviceInstance.InstanceUse;
...
import delivery.pipeline.ui.cf.info.CfInfo;
import delivery.pipeline.ui.cf.url.CfUrl;
import delivery.pipeline.ui.job.Job;
...
public class AspectService {
     ...
     * @return the object
     */
    @Around("execution(* delivery.pipeline.ui.*.*Service.setCreate*(..)) || execution(* delivery.pipeline.ui.*.*Service.setUpdate*(..)) " +
            " || execution(* delivery.pipeline.ui.*.*.*Service.setCreate*(..)) || execution(* delivery.pipeline.ui.*.*.*Service.setUpdate*(..)) " +
            " || execution(* delivery.pipeline.ui.*.*Service.setReplicate*(..))")
